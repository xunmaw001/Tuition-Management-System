...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">反馈信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>反馈信息管理</span></li>
								<li class="breadcrumb-item active"><span>反馈信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">反馈信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										反馈编号
									</label>
									<input type="text" id="fankuibianhaoSearch" class="form-control form-control-sm" placeholder="请输入反馈编号" aria-controls="tableId">
									<label>
										学号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('fankuibianhao')">反馈编号<i id="fankuibianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('fankuimingcheng')">反馈名称<i id="fankuimingchengIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#fankuibianhaoSearch').val() != null && $('#fankuibianhaoSearch').val() != ''){
				searchForm.fankuibianhao ="%" +  $('#fankuibianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("fankuixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				fankuibianhao : searchForm.fankuibianhao,	
		...
		function setDataRow(item,number){
			...
			var fankuibianhaoCell  = document.createElement('td');

						 fankuibianhaoCell.innerHTML = item.fankuibianhao;

			row.appendChild(fankuibianhaoCell);
			var fankuimingchengCell  = document.createElement('td');

						 fankuimingchengCell.innerHTML = item.fankuimingcheng;

			row.appendChild(fankuimingchengCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("fankuixinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("fankuixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fankuixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"fankuixinxi");
