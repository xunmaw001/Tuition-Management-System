...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑反馈信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑反馈信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">反馈信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>反馈名称</label>
										<input name="fankuimingcheng" id="fankuimingcheng" name="fankuimingcheng" class="form-control" placeholder="反馈名称">
									</div>
									<div class="form-group col-md-6">
										<label>反馈时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "fankuixinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("fankuixinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("fankuixinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#fankuimingcheng").val(ruleForm.fankuimingcheng);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.fankuibianhao != null && res.data.fankuibianhao != ''){
						...
						$("#fankuibianhao").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.fankuimingcheng != null && res.data.fankuimingcheng != ''){

						$("#fankuimingcheng").val(res.data.fankuimingcheng);
						$("#fankuimingcheng").attr('readonly','readonly');
					}
