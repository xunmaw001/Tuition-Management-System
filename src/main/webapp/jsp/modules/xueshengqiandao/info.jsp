						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="qiandaobianhao" name="qiandaobianhao" class="form-control" v-model="ruleForm.qiandaobianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>签到位置</label>

									<input id="qiandaoweizhi" name="qiandaoweizhi" class="form-control" v-model="ruleForm.qiandaoweizhi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>签到时间</label>
