...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>签到编号</label>
										<input id="qiandaobianhao" name="qiandaobianhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>签到位置</label>
										<input name="qiandaoweizhi" id="qiandaoweizhi" name="qiandaoweizhi" class="form-control" placeholder="签到位置">
									</div>
									<div class="form-group col-md-6">
										<label>签到时间</label>
	...
	<script>
		...
		function qiandaobianhaoUuid(){
			if($("#qiandaobianhao").val() == null || $("#qiandaobianhao").val() == "null" || $("#qiandaobianhao").val() == ""){
				$("#qiandaobianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		...
		function dataBind(){
			...
			$("#qiandaobianhao").val(ruleForm.qiandaobianhao);	
			$("#qiandaoweizhi").val(ruleForm.qiandaoweizhi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.qiandaobianhao != null && res.data.qiandaobianhao != ''){

						$("#qiandaobianhao").val(res.data.qiandaobianhao);
						$("#qiandaobianhao").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.qiandaoweizhi != null && res.data.qiandaoweizhi != ''){

						$("#qiandaoweizhi").val(res.data.qiandaoweizhi);
						$("#qiandaoweizhi").attr('readonly','readonly');
					}
