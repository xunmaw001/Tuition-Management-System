...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="qiandaoweizhiSearch" class="form-control form-control-sm" placeholder="请输入签到位置" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('qiandaobianhao')">签到编号<i id="qiandaobianhaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qiandaoweizhi')">签到位置<i id="qiandaoweizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#qiandaoweizhiSearch').val() != null && $('#qiandaoweizhiSearch').val() != ''){
				searchForm.qiandaoweizhi ="%" +  $('#qiandaoweizhiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("xueshengqiandao/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				qiandaoweizhi : searchForm.qiandaoweizhi,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var qiandaobianhaoCell  = document.createElement('td');

						 qiandaobianhaoCell.innerHTML = item.qiandaobianhao;

			row.appendChild(qiandaobianhaoCell);
			var qiandaoweizhiCell  = document.createElement('td');

						 qiandaoweizhiCell.innerHTML = item.qiandaoweizhi;

			row.appendChild(qiandaoweizhiCell);
		...
		function sh(){
			...
			httpJson("xueshengqiandao/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
