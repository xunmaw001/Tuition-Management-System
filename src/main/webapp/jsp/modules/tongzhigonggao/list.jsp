...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('gonggaobianhao')">公告编号<i id="gonggaobianhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var gonggaobianhaoCell  = document.createElement('td');

						 gonggaobianhaoCell.innerHTML = item.gonggaobianhao;

			row.appendChild(gonggaobianhaoCell);
			...
			var fabuneirongCell  = document.createElement('td');
